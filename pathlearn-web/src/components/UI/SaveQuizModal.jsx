...
import { X, Save, MapPin, Brain, Database } from 'lucide-react'

export default function SaveQuizModal({ generationMeta, locationName, poisCount, onSave, onClose }) {
  ...
  const isAI = generationMeta?.poiSource === 'ai'
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-stone-100">
          <div className="flex items-center gap-2.5">
            ...
            <h2 className="text-base font-black text-stone-900 tracking-tight">Guardar quiz</h2>
          </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3 p-3 bg-stone-50 rounded-xl border border-stone-200 text-xs">
            ...
            <span className="flex items-center gap-1.5 text-stone-600">
              ...
              <span>{isAI ? 'IA Generativa' : 'OpenStreetMap'}</span>
            </span>
            <span className="text-stone-500">
              <span className="font-bold text-stone-700">{poisCount}</span> POIs
            </span>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Barrio Gótico, Barcelona"
              autoFocus
              maxLength={80}
